...
extension MainViewController: ThemeSwitchProtocol {
    ...
    func switchTheme(style: ShengwangChatUIKit.ThemeStyle) {
...
extension  MainViewController: ConversationEmergencyListener {
    func onResult(error: ShengwangChatUIKit.ChatError?, type: ShengwangChatUIKit.ConversationEmergencyType) {
        //show toast or alert,then process
    }
    
    func onConversationLastMessageUpdate(message: ShengwangChatUIKit.ChatMessage, info: ShengwangChatUIKit.ConversationInfo) {
...
extension MainViewController: ContactEmergencyListener {
    func onResult(error: ShengwangChatUIKit.ChatError?, type: ShengwangChatUIKit.ContactEmergencyType, operatorId: String) {
        if type != .setRemark {
    ...
    private func updateContactBadge() {
        if let newFriends = UserDefaults.standard.value(forKey: "ShengwangChatUIKit_contact_new_request") as? Array<Dictionary<String,Any>> {
