...
@objc open class ConversationList: UITableView {
    ...
    @objc required public override init(frame: CGRect, style: UITableView.Style) {
        ...
        self.delegate(self).dataSource(self).tableFooterView(UIView()).separatorStyle(.none).registerCell(ComponentsRegister.shared.ConversationCell.self , forCellReuseIdentifier: "ShengwangChatUIKit.ConversationCell").rowHeight(Appearance.conversation.rowHeight).backgroundColor(.clear)
...
extension ConversationList: UITableViewDelegate,UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        var cell = tableView.dequeueReusableCell(with: ComponentsRegister.shared.ConversationCell, reuseIdentifier: "ShengwangChatUIKit.ConversationCell")
        if cell == nil {
            cell = ComponentsRegister.shared.ConversationCell.init(style: .default, reuseIdentifier: "ShengwangChatUIKit.ConversationCell")
        }
        if let info = self.datas[safe: indexPath.row] {
